...
class CFR_sys():
    ...
    def save_matrix(self):
        with open('./inverted_list_'+str(self.movie_id_end),'wb') as il:
            pickle.dump(self.inverted_list_dict,il)
        with open('./co_matrix_'+str(self.movie_id_end),'wb') as out:
            # out.write(str(self.co_matrix))
            pickle.dump(self.co_matrix,out)
        with open('./sim_matrix_'+str(self.movie_id_end),'wb') as out_:
